...
class MainWindow(QMainWindow):
    def __init__(self, entitlement: LocalLicenseProvider | None = None) -> None:
        ...
        self.backend_log_separator = view_menu.addSeparator()
        self.backend_log_action = self.log_dock.toggleViewAction()
        view_menu.addAction(self.backend_log_action)
        self.backend_log_separator.setVisible(False)
        self.backend_log_action.setVisible(False)
